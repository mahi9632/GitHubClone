...
const ProfilePage: React.FC = () => {
  ...
  const { fetchUserProfile, fetchContributionsByYear, loading, error, user, fetchPopularRepositories } = useUserProfile();
        ...
        <div className="flex flex-col lg:flex-row gap-6 mt-8">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex flex-col  border border-[#30363d] rounded-md flex-1 min-w-0">
                ...
                <div className="flex flex-row gap-2 w-full p-4 border-t-4 border-t-[#30363d]">
                  <div className="w-1/2 border-r-2 border-r-[#30363d]">
                    ...
                    <div className="flex flex-row gap-2 text-sm items-center">
                      <GoRepo /> Contributed 
                        <a href="">mahi9632</a>, <a href="">vishalMn</a>to and 13 others
                    </div>
                  </div>
                  <ActivityOverview />
                </div>
